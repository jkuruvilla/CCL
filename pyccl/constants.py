...
from pyccl.ccllib import \
  ...
  CCL_CORR_FFTLOG_PROJECTED,CCL_CORR_FFTLOG_3D, CCL_CORR_BESSEL, CCL_CORR_LGNDRE, CCL_CORR_GG, CCL_CORR_GL, CCL_CORR_LP, CCL_CORR_LM,CCL_CORR_ANG,CCL_CORR_PHYS, CCL_CORR_LM
